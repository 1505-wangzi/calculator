...
public class CalculatorActivity extends Activity  implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fenshu_btn=(Button)findViewById(R.id.fenshu_btn);
        ...
        fenshu_btn.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.jinzhi_btn:
                ...
                isClickEqu=true;
                break;
            case R.id.fenshu_btn:
                String myStringfenshu=show.getText().toString();
                num1=Double.valueOf(myStringfenshu);
                double numfenshu=1/num1;
                String showfenshu=String.valueOf(numfenshu);
                show.setText(showfenshu);
                isClickEqu=true;
                break;
            case R.id.equal_but:
